...
def cal_sample(data,name1,name2):
    ...
    p_samples,p_distance = write_kmeans(p_data,p_y_pred,p_y_ground,pos_index,2,0.075)
    #write_kmeans(n_data,n_y_pred,n_y_ground,neg_index)
    n_samples,n_distance = write_kmeans(n_data,n_y_pred,n_y_ground,neg_index,2,0.054)
    ...
    print(tp,fn,tn,fp,tp/(tp+fn),tn/(tn+fp),(tp+tn)/(tp+fn+fp+tn),edit_score*base,edit_score_2*base,p_distance)
