...
import predictoutput as predict
import compose_new
...
#   理论上只需要修改话题名topic_name和模型名\test_result名
topic_name = "权力的游戏tmp"
...
result_topic_epoch_dir = os.path.join(result_topic_dir,'epoch_10')
...
if not os.path.exists(result_topic_epoch_dir):
    os.mkdir(result_topic_epoch_dir)
...
parser.add_argument('--test-result',type=str, default=result_topic_epoch_dir)
...
parser.add_argument("--load-model", type=str, default="saved_model/权力的游戏/ckpt-epoch-10")
