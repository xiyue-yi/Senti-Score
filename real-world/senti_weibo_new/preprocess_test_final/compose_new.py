...
check_data_dir = os.path.join("./check_data",topic_name)


if not os.path.exists(check_data_dir):
    os.mkdir(check_data_dir)
'''
def create_new(data_dir,result_dir,check_data_dir):
    text_data_list = []
    text_data_dict = {}
    result_data_list = []
    result_data_dict = {}
...
def main():
    create_new(data_dir,result_dir,check_data_dir)
