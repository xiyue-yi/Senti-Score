...
parser.add_argument('--input-train', type=str, default="preprocessed_data/"+topic_name+"/train.json")
parser.add_argument('--input-dev', type=str, default="preprocessed_data/"+topic_name+"/dev.json")
...
parser.add_argument('--test-result',type=str, default='result/')
parser.add_argument('--input-dir',type=str, default='preprocessed_data/权力的游戏')
parser.add_argument('--use-cpu', type=bool, default=True)
parser.add_argument('--gpu-devices', type=str, default="0")
parser.add_argument('--seed', type=int, default=42)

parser.add_argument("--resume", type=bool, default=False)
parser.add_argument("--load-model", type=str, default="saved_model/1/ckpt-epoch-2")
...
def main():
    ...
    result_name = os.path.join(args.test_result,'test.txt')
