...
def get_vary_recalls(all_num,pos_neg,flag):
	...
	recall_list = list(i/1000 for i in range(600,845,1))
	...
	for recall_vary in recall_list:
		...
		accuracy_list = list(i/1000 for i in range(600,845,1))
		for accuracy_vary in accuracy_list:
			...
			print('recall_1:',recall_1_vary,'recall_2',recall_2_vary,'recall_2_ori',recall_2_ori)
			y_test,predictions = generate_lists(tp,fn,fp,tn)

			assert(len(y_test)==len(predictions))
			
			groundtruth_score = pos_neg*(2.0*accuracy_vary/(2.0*recall_vary-1.0)-1.0) + ((2.0*accuracy_vary-2.0)/(2.0*recall_vary-1.0)-1.0)
			print('groundtruth_score',groundtruth_score,'r',recall_vary,'a',accuracy_vary)
			predict_diata = abs(groundtruth_score-pos_neg+1)
			...
			print('total',total_score,'better',better_score,'r',recall_vary,'a',accuracy_vary,'\n')
