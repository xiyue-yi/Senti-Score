...
def main():
	...
	bt_list = []
	total_list = []
	with open("new_data_10.txt",'r') as data:
	...
	new_error_dict = {}
	new_rate_dict = {}
	precision_list = list(i/1000 for i in range(900,975,1))
	accuracy_list = list(i/1000 for i in range(900,975,1))
	...
	for p in precision_list:
		...
		if(len(new_ed_list)!=175 or len(new_bt_list)!=175):
			print("hsdiofhi")
