...
def get_vary_recalls(all_num,pos_neg,flag):
	...
	for recall_1_vary in recall_1_list:
		...
		#for rate in range(5,20):
			...
			print(float(rate/100),recall_1_vary,recall_2_vary,mean_recall_1,std_recall_1,mean_recall_2,std_recall_2,mean_accuracies,std_accuracies,'\n')
...
def main():
	...
	for all_num in [2000]:
		for pos_neg in [9,3,1,0.5,0.111]:		
